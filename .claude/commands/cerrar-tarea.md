---
description: Cierra una tarea siguiendo el flujo de FadeForge API — tests, diff, OK explícito, commit convencional, push y PR
argument-hint: [descripcion-breve-opcional]
---
